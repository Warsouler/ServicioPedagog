...
namespace Servicio.Controllers
{
    ...
    {
        private ICareersServices _services;
        public CareersController(ICareersServices services)
        {
            _services = services;
        }
        ...
        Int32 top = 9999999, String orderby = nameof(CareersBE.idcareers), String ascending = "asc", String name = "")
        {
            var count = 0;
            List<CareersBE> query = _services.GetAll(state, page, top, orderby, ascending, name, ref count);
            PaginationList<CareersBE> mylist = new PaginationList<CareersBE>(query, count);
            return Ok(mylist);
